  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-xl font-black text-slate-900 dark:text-white tracking-tight">Manage Sub Courses</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Configure exam sub-courses dynamically under parent courses/categories.</p>
        </div>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-850">
                {filteredCourses.map((c) => (
                  <tr key={c.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-955/20 text-slate-600 dark:text-slate-350 transition-colors">
                    ...
                    {/* Sub Course ID */}
                    <td className="py-4 px-6 font-mono text-xs font-black tracking-wider text-emerald-700 dark:text-emerald-400 select-all">
                    ...
                    <td className="py-4 px-5">
                      ...
                      <div className="mt-1 inline-flex items-center gap-1">
                        <span className="text-[10px] font-bold text-slate-400">Parent Course:</span>
                        <span className="rounded-md bg-violet-50 dark:bg-violet-950/40 border border-violet-200/60 dark:border-violet-800/40 px-2 py-0.5 text-[10px] font-extrabold text-violet-700 dark:text-violet-300">
                    ...
                    <td className="py-4 px-5">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out outline-none disabled:opacity-50 ${
          ...
          <div className="w-full max-w-md rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-2xl relative space-y-5">
            ...
            <div className="text-center space-y-2">
              ...
              <h3 className="text-base font-extrabold text-slate-955 dark:text-white">
                {isEditMode ? "Edit Sub Course Details" : "Create New Sub Course"}
              </h3>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold">
                {isEditMode ? "Modify sub course name and parent course in the database." : "Configure a sub course option under a parent course for students to enroll in."}
              </p>
            </div>
            ...
            <form onSubmit={handleSaveCourse} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. History (Class 6th - 8th)"
              ...
              <div className="pt-2 flex justify-end gap-3.5">
                ...
                >
                  {actionLoading === "create" || actionLoading === "edit" ? (
                    ...
                    isEditMode ? "Save Changes" : "Create Sub Course"
                  )}
                </button>
              </div>
            </form>
