						...
						<div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
							<div>
								...
								<div className="mt-8 flex gap-3">
									<a
										href="#programs"
										className="inline-flex items-center justify-center rounded-full bg-brand-gradient px-5 py-3 text-sm font-bold text-white shadow-md hover:opacity-95 transition"
									>
										View programs
									</a>
									<a
										href="#contact"
										className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-slate-950 shadow-sm hover:border-[#5d00e5] hover:text-[#5d00e5] transition"
									>
										Contact us
									</a>
								</div>
